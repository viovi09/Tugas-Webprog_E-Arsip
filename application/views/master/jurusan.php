<div class="content-wrapper">
	...
	<section class="content container-fluid">
		<div class="row">
			<div class="col-md-12">
				<div class="box">
					<div class="box-header bg-yellow">Data Jurusan</div>
					<div class="box-body table-responsive">
						<table class="table table-bordered table-striped data">
							...
							<tbody>
								<?php $no=1; foreach($jurusan as $key=>$row){ ?>
								<tr>
									<td><?php echo $no++ ?></td>
									<td><?php echo $row->kode ?></td>
									<td><?php echo $row->jurusan ?></td>
									<td width="10%" align="center">
										<a href="<?php echo base_url('Master/del_jurusan/'. $row->id) ?>">
...
<form action="<?php echo base_url('Master/add_jurusan') ?>" method="post" enctype="multipart/form-data" class="form-horizontal">

<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title" id="exampleModalLabel"><i class="fas fa-file"></i> Tambah Jurusan</h4>
      ...
      <div class="modal-body">
        	<div class="form-group">
        		...
        		<div class="col-md-9">
        			<input type="text" class="form-control" name="kode" id="kode" placeholder="Kode Jurusan" autocomplete="off" required>
        		</div>
        	</div>
        	<div class="form-group">
        		<label for="jurusan" class="control-label col-md-3">Jurusan :</label>
        		<div class="col-md-9">
        			<input type="text" class="form-control" name="jurusan" id="jurusan" placeholder="Jurusan" autocomplete="off" required>
        		</div>
        	</div>
      </div>
