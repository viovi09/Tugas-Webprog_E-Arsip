...
(33, 'aasdasdas11', 'dasdasdas1', '01-06-2021', 'asdasdas', 'asdasdqwqsas', '2021', '1624975711-File_demo.pdf', '1624975711-File_demo.pdf');
...
CREATE TABLE `users` (
  ...
  `password` varchar(255) NOT NULL,
  `full_name` varchar(30) NOT NULL,
  `level` enum('Admin','Komite','Guru','Kepala Sekolah') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
(7, 'admin', '$2y$10$of8pjbbhQFxcJAP6zazcTe8ZVrjYUnHJbQxkxjL2e8W2Zjq/C/zBq', 'Budiono', 'Admin'),
...
(21, 'kepsek', '$2y$10$hBOs.WIayx04A8kFYZ12m.hB7TklE54e4kytAxRrL1htKBdZ/VDS.', 'Budi Tam', 'Kepala Sekolah');
